...
public class RangeSeekBar2 extends View {
    ...
    public RangeSeekBar2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public RangeSeekBar2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnRangeSeekBarChangeListener {
        void onRangeSeekBarValuesChanged(RangeSeekBar2 bar, long minValue, long maxValue, int action, boolean isMin, int pressedThumb);
    }
