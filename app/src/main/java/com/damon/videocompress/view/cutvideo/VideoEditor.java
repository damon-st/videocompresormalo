...
import com.damon.videocompress.adapters.VideoEditAdapter;
...
public class VideoEditor extends FrameLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        seekBar = (RangeSeekBar2) findViewById(R.id.seekBar);
    ...
    public void setFilePath(String path) {
        ...
        duration = extractVideoInfoUtil.getVideoLength2();
        leftProgress = 0;
        rightProgress = duration;
        seekBar.setMaxTrimMs(duration);
        seekBar.setThubmPos(RangeSeekBar2.MIN, 0);
        seekBar.setThubmPos(RangeSeekBar2.MAX, duration);
    }

    public void setSeekListener(final RangeSeekBar2.OnRangeSeekBarChangeListener listener) {
        seekBar.setOnRangeSeekBarChangeListener(new RangeSeekBar2.OnRangeSeekBarChangeListener() {
            @Override
