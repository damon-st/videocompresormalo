...
import com.damon.videocompress.interfaces.WaveformListener;
import com.damon.videocompress.utils.AfterSaveActionDialog;
import com.damon.videocompress.utils.FileSaveDialog;
import com.damon.videocompress.utils.TimeFormat;
import com.damon.videocompress.utils.soundFile.SamplePlayer;
import com.damon.videocompress.utils.soundFile.SongMetadataReader;
import com.damon.videocompress.utils.soundFile.SoundFile;
import com.damon.videocompress.view.MarkerView;
import com.damon.videocompress.view.WaveformView;
...
public class CutAudioActivity extends AppCompatActivity implements MarkerListener, WaveformListener, OnClickListener {
     ...
     */
    public static final String EDIT = "com.audioextract.action.EDIT";
    ...
    public void onCreate(Bundle icicle) {
        ...
        mFilePath = intent.getStringExtra("audiopath");
        mSoundFile = null;
        mKeyDown = false;
    ...
    private void initView() {
        ...
        mFfwdButton = findViewById(R.id.nextfwd);
        findViewById(R.id.saveas_ring).setOnClickListener(this);
        findViewById(R.id.saveaudio).setOnClickListener(this);
        findViewById(R.id.return_back).setOnClickListener(this);
        findViewById(R.id.reset_act).setOnClickListener(this);
    ...
    private void loadFromFile() {
        ...
        SongMetadataReader metadataReader = new SongMetadataReader(
                this, mFilePath);
        mTitle = TimeFormat.getCurrentTime();////metadataReader.mTitle;
        ...
        mProgressDialog = new ProgressDialog(CutAudioActivity.this);
    ...
    private void recordAudio() {
        ...
        mFinishActivity = false;
        AlertDialog.Builder adBuilder = new AlertDialog.Builder(CutAudioActivity.this);
    ...
    private String makeRingtoneFilename(CharSequence title, String extension) {
        ...
        switch(mNewFileKind) {
            ...
            case FileSaveDialog.FILE_KIND_MUSIC:
                ...
                subdir =  getResources().getString(R.string.app_name)+"/media/music/";
                break;
            case FileSaveDialog.FILE_KIND_ALARM:
                subdir = getResources().getString(R.string.app_name)+"/media/alarms/";
                break;
            case FileSaveDialog.FILE_KIND_NOTIFICATION:
                subdir = getResources().getString(R.string.app_name)+"/media/notifications/";
                break;
            case FileSaveDialog.FILE_KIND_RINGTONE:
                subdir = getResources().getString(R.string.app_name)+"/media/ringtones/";
                break;
        }
            ...
            public void run() {
                ...
                if (fallbackToWAV) {
                    ...
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                Toast.makeText(CutAudioActivity.this, "Guardado Exitoso", Toast.LENGTH_SHORT).show();
                                mInfo.setText(mInfoContent);
                            }
                        });
